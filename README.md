...
`amr` claims for both the exact and cumulative clients.
...
The test lives at [`providers-src/src/test/java/it/westlund/kc/acr/AcrExactConditionIT.java`](providers-src/src/test/java/it/westlund/kc/acr/AcrExactConditionIT.java).
...
providers/acr-exact-condition.jar   Built provider (mounted into the container)
